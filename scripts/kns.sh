...
# This script is a modified version of the original kubectl-node-shell script
# It is used to spawn a shell in a node, and it is used to exec on to the node
#
# to use, run: 
# curl -fsSL https://kns.matmerr.com -o kns.sh
# chmod +x kns.sh
#
# - The Retina Devs
...
image="${KUBECTL_NODE_SHELL_IMAGE:-acnpublic.azurecr.io/toolbox:v24}"
