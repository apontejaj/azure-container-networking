...
func (in *ClusterInterfaceInfo) DeepCopyInto(out *ClusterInterfaceInfo) {
	*out = *in
	if in.Routes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterInterfaceInfo.
func (in *ClusterInterfaceInfo) DeepCopy() *ClusterInterfaceInfo {
	if in == nil {
		return nil
	}
	out := new(ClusterInterfaceInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MultitenantPodNetworkConfigStatus) DeepCopyInto(out *MultitenantPodNetworkConfigStatus) {
	*out = *in
	...
	if in.ClusterInterfaceInfos != nil {
		in, out := &in.ClusterInterfaceInfos, &out.ClusterInterfaceInfos
		*out = make([]ClusterInterfaceInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
