...
func TestMetrics(t *testing.T) {
	...
	iMgr.AddToSets([]*IPSetMetadata{nsY}, "5.6.7.8", "pod2")
	iMgr.AddToLists([]*IPSetMetadata{nsList3}, []*IPSetMetadata{nsX})
	iMgr.RemoveFromSets([]*IPSetMetadata{nsW, nsX}, "1.2.3.4", "pod1")
	iMgr.RemoveFromList(nsList1, []*IPSetMetadata{nsW})
	iMgr.RemoveFromList(nsList2, []*IPSetMetadata{nsW})
